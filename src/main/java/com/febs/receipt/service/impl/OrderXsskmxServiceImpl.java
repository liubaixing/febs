...
public class OrderXsskmxServiceImpl extends ServiceImpl<OrderXsskmxMapper, OrderXsskmx> implements IOrderXsskmxService {
    ...
    @Override
    public IPage<OrderXsskmxResp> findOrderXsskmxs(QueryRequest request, OrderXsskmx orderXsskmx) {
        Page<OrderXsskmx> page = new Page<>(request.getPageNum(), request.getPageSize());
        return this.orderXsskmxMapper.selectPageByQuery(page, orderXsskmx);
    }

    @Override
    public List<OrderXsskmxResp> findOrderXsskmxs(OrderXsskmx orderXsskmx) {
		return this.orderXsskmxMapper.selectByQuery(orderXsskmx);
    }

    @Override
    @Transactional
    public void createOrderXsskmx(OrderXsskmx orderXsskmx) {
        this.orderXsskmxMapper.insertSelective(orderXsskmx);
    }

    @Override
    @Transactional
    public void updateOrderXsskmx(OrderXsskmx orderXsskmx) {
        this.orderXsskmxMapper.updateByPrimaryKeySelective(orderXsskmx);
    }
